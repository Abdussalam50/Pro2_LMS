...
<body>
    ...
    <nav id="navbar">
        <a href="#" class="nav-brand">
            <img src="{{ asset('/icons/icon512_maskable.png') }}" alt="Logo" style="width: 56px; height: 56px; border-radius: 50%; margin-right: 0.5rem; object-fit: cover;">
        ...
        <ul class="nav-links">
            ...
            <li class="lang-switch">
                <a href="{{ url('/') }}?lang=id" class="{{ $lang == 'id' ? 'active' : '' }}">ID</a>
                <span style="color:var(--text-muted)">|</span>
                <a href="{{ url('/') }}?lang=en" class="{{ $lang == 'en' ? 'active' : '' }}">EN</a>
            </li>

            <li class="mobile-only-actions">
                <a href="{{ route('login') }}" class="btn btn-outline">{{ $t['nav_login'] }}</a>
                <a href="{{ route('login') }}" class="btn btn-primary">{{ $t['nav_signup'] }}</a>
            </li>
        </ul>
        <div class="nav-actions">
            <a href="{{ route('login') }}" class="btn btn-outline" style="padding: 0.6rem 1.5rem;">{{ $t['nav_login'] }}</a>
            <a href="{{ route('login') }}" class="btn btn-primary" style="padding: 0.6rem 1.5rem;">{{ $t['nav_signup'] }}</a>
        </div>
    ...
    <section id="beranda" class="hero">
        <div class="hero-content animate-fade-up">
            ...
            <div class="hero-actions">
                <a href="{{ route('login') }}" class="btn btn-primary">{{ $t['hero_btn_start'] }}</a>
        ...
        <div class="hero-visual animate-fade-up delay-2">
            ...
            <div class="hero-image-wrapper">
                ...
                <img src="{{ asset('gen-1.png') }}" loading="lazy" alt="Modern LMS Dashboard UI">
            </div>
    ...
    <section>
        <div class="cta-section animate-fade-up">
            ...
            <div class="cta-content">
                <h2>{{ $t['cta_h2'] }}</h2>
                <p>{{ $t['cta_p'] }}</p>
                <a href="{{ route('login') }}" class="btn btn-white" style="font-size: 1.1rem; padding: 1.25rem 3rem;">{{ $t['cta_btn'] }}</a>
            </div>
        </div>
    </section>
